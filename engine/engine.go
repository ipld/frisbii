...
import (
	...
	"github.com/rvagg/go-frisbii/httpsync"
)
...
func (e *Engine) newPublisher() (dagsync.Publisher, error) {
	...
	if e.pubKind == HttpPublisher {
		if e.pubHttpWithoutServer {
			return httpsync.NewPublisherWithoutServer(e.pubHttpListenAddr, e.pubHttpHandlerPath, e.lsys, e.key, httpsync.WithAnnounceSenders(senders...))
		}
